...
<div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Decline Reservation</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Decline Reservation</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->     
            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
						...
						$days=$diff->format("%a");
				?>
                                    <form class="form-valide"  method="POST" action = "declinereservation_query.php?transaction_id=<?php echo $row['transaction_id']?>&guest_id=<?php echo $row['guest_id']?>" enctype="multipart/form-data">
                                      ...
                                      <div class="form-group row">
                                       ...
                                       <label class="col-lg-4 col-form-label" for="val-username">Subject For Email: <span class="text-danger"></span></label>
                                         ...
                                         <div class="form-group row">
                                       <label class="col-lg-4 col-form-label" for="val-username">Decline Message: <span class="text-danger"></span></label>
                                            <div class="col-lg-6">
                                               <textarea id="val-username" name="message" rows="8" cols="48" required="">Thank you for choosing De La Salle Hotel School. We are very sorry to "DECLINE" the following reservation due to some reason. If you have question, please do not hesitate to contact the hotel directly. You can call us at (2 8330 9128) local (2147) or you can Direct Message us on our Facebook Page listed below.</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-lg-8 ml-auto">
                                                <button type="submit" class="btn btn-success" name= "decline_reserve">Decline Reservation</button>
