...
<div class="popup popup--icon -question js_question-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>
      <a href="del_checkoutrecord.php?checkout_id=<?php echo $_GET['checkout_id']?>" class="button button--success" data-for="js_success-popup">Yes</a>
      <a href="checkout.php" class="button button--error" data-for="js_success-popup">No</a>
    </p>
  </div>
</div>
<?php } ?>
                 ...
                 <thead>
					...
					<tbody>
						...
						<tr>
							...
							<!--<td><center><a class = "btn btn-danger" href = "checkout.php?checkout_id=<?phpecho $row['checkout_id']?>"><i class = "glyphicon glyphicon-check"></i> Delete Record</a></center></td>-->
						</tr>
						<?php $i++; }?>
