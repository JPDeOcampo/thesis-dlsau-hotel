        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary"> Cancelled Pending Check In Details</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Cancelled Pending Check In Details</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
            ...
            <div class="container-fluid">
                ...
                <!-- /# row -->
                 ...
                 <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                           <h4 class="card-title">Cancelled Pending Check In Details</h4>
				...
				<br />
                  ...
                  <thead>
					...
					<tbody>
						<?php
							$sql = "SELECT * FROM `cancel_pendingcheckin`";
						...
						<tr>
							...
							<td>PHP <?php echo $row['total_balance']?>.00</td>
