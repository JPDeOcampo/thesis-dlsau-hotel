...
<div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Cancel Pending Check In</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Cancel Pending Check In</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->     
            ...
            <div class="container-fluid">
				...
				?>
                                    <form class="form-valide"  method="POST" action = "cancel_pendingcheckin_query.php?transaction_id=<?php echo $row['transaction_id']?>&guest_id=<?php echo $row['guest_id']?>" enctype="multipart/form-data">
                                       ...
                                       <label class="col-lg-4 col-form-label" for="val-username">Position: <span class="text-danger"></span></label>
                                        ...
                                        <label class="col-lg-4 col-form-label" for="val-username">Children: <span class="text-danger"></span></label>
                                            <div class="col-lg-6">
                                                <input readonly class="form-control" id="val-username" name="children" value="<?php echo $row['children']?>" >
                                            </div>
                                        </div>
										 <div class="form-group row">
                                      ...
                                      <div class="form-group row">
                                       ...
                                       <label class="col-lg-4 col-form-label" for="val-username">Check Out: <span class="text-danger"></span></label>
										...
										<div class="form-group row">
                                       <label class="col-lg-4 col-form-label" for="val-username">Advance Payment Status: <span class="text-danger"></span></label>
                                            <div class="col-lg-6">
                                                <input readonly class="form-control" id="val-username" name="deposit" value="<?php if($row['deposit'] == 50){echo "Advance 50% Payment";}else{echo "Advance Full Payment";}?>" >
                                            </div>
                                        </div>
											<div class="form-group row">
                                       <label class="col-lg-4 col-form-label" for="val-username">Advance Payment Method: <span class="text-danger"></span></label>
                                            <div class="col-lg-6">
                                                <input readonly class="form-control" id="val-username" name="deposit_method" value="<?php echo $row['deposit_method']?>" >
                                            </div>
                                        </div>
											  <div class="form-group row">
                                       ...
                                       <label class="col-lg-4 col-form-label" for="val-username">Discount Total: <span class="text-danger"></span></label>
											...
											<div class="form-group row">
                                       <label class="col-lg-4 col-form-label" for="val-username">Total Balance: <span class="text-danger"></span></label>
                                            <div class="col-lg-6">
                                                <input readonly class="form-control" id="val-username" name="total_balance" value="<?php echo $row['bill']?>.00" >
                                            </div>
                                        </div>
										<div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-skill"><mark>Have Cancellation Fee? </mark><span class="text-danger"></span></label>
                                            <div class="col-lg-6">
                                                <select class="form-control" id="val-skill" name="cancellation_fee" required>
													<option value = "">Please Select</option>
													<option value = "Already Paid">Yes, Already Paid</option>
										...
										<div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <select class="form-control" id="val-skill" name="payment_method" required>
												    <option value = "">Please Select</option>
													<option value = "No Cancellation Fee">No Cancellation Fee</option>
                                       ...
                                       <label class="col-lg-4 col-form-label" for="val-username">Subject For Email: <span class="text-danger"></span></label>
                                         ...
                                         <div class="form-group row">
                                       <label class="col-lg-4 col-form-label" for="val-username">Cancel Pending Check-In Message: <span class="text-danger"></span></label>
                                            <div class="col-lg-6">
                                               <textarea id="val-username" name="message" rows="8" cols="48" required="">WE RECEIVED YOUR REQUEST TO CANCEL YOUR RESERVATION AT DE LA SALLE HOTEL SCHOOL. We're very sorry you are not able to stay with us. If we can assist you with booking alternate dates, please message us on our Facebook Page listed below or call us on our hotline at (02) 330 9129. You can also email us here at dlsaulasallianhotel@gmail.com.</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-lg-8 ml-auto">
                                                <button type="submit" class="btn btn-success" name= "cancel_pendingcheckin">Cancel Pending Check In</button>
