...
if(isset($_POST['cancel_pendingreservation'])){
	...
	$conn->query("INSERT INTO `cancel_reservation` (firstname, lastname, email, address, contact, purposeofstay, position, adults, children, room_type, room_price, checkin, checkout, status, cancellation_fee, payment_method)
	             VALUES('$firstname', '$lastname', '$email', '$address', '$contact', '$purposeofstay', '$position', '$adults', '$children', '$room_type', '$room_price', '$checkin', '$checkout', 'Cancelled Reservation', '$cancellation_fee', '$payment_method')") or die(mysqli_error($conn));
