...
//if($_SESSION["username"]=='admin' || $_SESSION["username"]=='user'){
   ...
   $q = "select * from  admindash where id = '".$_SESSION['id']."'";
//}
//else {
...
//if($_SESSION["username"]=='admin' || $_SESSION["username"]=='user'){
   ...
   $sql = "update  admindash set `password`='$confirm' where id = '".$_SESSION['id']."'";
//}
//else {
...
//}    
  ...
  <div class="popup__content">
    ...
    <p>
 <!--<?phpif($_SESSION["username"]=='admin' || $_SESSION["username"]=='user'){ ?>-->
