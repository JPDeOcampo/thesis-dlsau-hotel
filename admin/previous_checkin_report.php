        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Previous Check Out Report</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Previous Check Out Report</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
            ...
            <div class="container-fluid">
              ...
              <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Previous Check Out Report</h4>
				   ...
				   <table id="example23" class="newTable" cellspacing="0">
							...
							<th>Payment Status</th>
                                    ...
                                    if(isset($_POST['Done']))
                                    {
                                      ...
                                      $sql = "SELECT * FROM `checkout_report` WHERE `status` = 'Check Out' AND checkin BETWEEN '".$_POST['fromDate']."' AND '".$_POST['toDate']."' ";
