            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
						...
						$days=$diff->format("%a");
				?>
                                    <form class="form-valide"  method="POST" action = "cancel_pendingreservation_query.php?transaction_id=<?php echo $row['transaction_id']?>&guest_id=<?php echo $row['guest_id']?>" enctype="multipart/form-data">
