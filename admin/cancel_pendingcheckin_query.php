...
if(isset($_POST['cancel_pendingcheckin'])){
	...
	$conn->query("INSERT INTO `cancel_pendingcheckin` (firstname, lastname, email, address, contact, purposeofstay, position, adults, children, room_type, room_price, checkin, days, checkout, deposit_total, discount, discount_total, deposit, deposit_method, total_balance, status, cancellation_fee, payment_method)
	             VALUES('$firstname', '$lastname', '$email', '$address', '$contact', '$purposeofstay', '$position', '$adults', '$children', '$room_type', '$room_price', '$checkin', '$days', '$checkout', '$deposit_total', '$discount', '$discount_total', '$deposit', '$deposit_method', '$total_balance', 'Cancelled Pending Check In', '$cancellation_fee', '$payment_method')") or die(mysqli_error($conn));
    ...
    <body style="background-color: #fafafa;">
        <div align=center>
            <table width=600 border=1 bordercolor=#00000>
				...
				<tr>
						<td colspan=5 bordercolor=#00000 bgcolor=#13322b>
                        <div align=left style="color:#FFFFFF"><strong>Status: <mark>'.$deposit.'</mark></strong></div>
                <tr>
				  ...
				  <tr>
                    <td bordercolor=#00000 bgcolor=#13322b>
                        <div align=left><span class=style4>Total:</span></div>
                    <td colspan=4 bordercolor=#00000 bgcolor=#13322b><strong>PHP '.$total_balance.'</strong>&nbsp;	
                ...
                <tr>
                    <td colspan=5 bordercolor=#00000 bgcolor=#13322b>
                        <div align=left>
                            <p align=left>The Lasallian Hotel. <a href=https://dlsau-hotel.xyz>www.dlsau-hotel.xyz</a> | <a href=https://www.facebook.com/hoteldelasalle/>www.facebook.com/hoteldelasalle</a>
                        </div>
            </table>
        </div>
    </body>
...
?>
	<script>
	alert("Successfully Cancel a Pending Check In!");
	window.location = "cancel_pendingcheckin_details.php";
    </script>
