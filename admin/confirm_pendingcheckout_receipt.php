                    ...
                    <div class="col-lg-6">
                        ...
                        $days=$diff->format("%a");
				              ?>
				                ...
				                <br />
                                    <form class="form-valide"  method="post" action="pendingcheckout_receipt_query.php?transaction_id=<?php echo $row['transaction_id']?>&guest_id=<?php echo $row['guest_id']?>" enctype="multipart/form-data">
