                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
				                ...
				                <br />
                                    <form class="form-valide"  method="post" action="edit_pendingcheckin_query.php?transaction_id=<?php echo $row['transaction_id']?>&room_id=<?php echo $row2['room_id']?>" enctype="multipart/form-data">
										...
										<div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="number" class="form-control" id="val-digits" name="adults" value="<?php echo $row['adults']?>" onKeyDown="return false" min="1" max="5" required="">
                                            </div>
                                        </div>
                                       	<div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-digits">Children: <span class="text-danger"></span></label>
                                            <div class="col-lg-6">
                                                <input type="number" class="form-control" id="val-digits" name="children" value="<?php echo $row['children']?>" onKeyDown="return false" min="0" max="5" required="">
                                            </div>
                                        </div>
										  
                                        <div class="form-group row">
                                            <div class="col-lg-8 ml-auto">
                                                <button type="submit" class="btn btn-success" name="change_pendingcheckin">Confirm Change</button>
                                            </div>
                                        </div>
                                    </form>
						    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
					   <form class="form-valide" method="post" action="upgrade_pciroom_query.php?transaction_id=<?php echo $row['transaction_id']?>&room_id=<?php echo $row2['room_id']?>" enctype="multipart/form-data">
                                      <div class="form-group row">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
					   <form class="form-valide" method="post" action="edit_pcidate_query.php?transaction_id=<?php echo $row['transaction_id']?>&room_id=<?php echo $row2['room_id']?>" enctype="multipart/form-data">
                                      <div class="form-group row">
										...
										<div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="date" class="form-control" id="val-digits" name="checkin" min="<?php echo date("Y-m-d");?>" value="<?php echo $row['checkin']?>" onkeydown="return false">
                                            </div>
                                        </div>
										...
										<div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input readonly class="form-control" id="val-digits" name="dayss" value="<?php echo $days?>">
                                            </div>
                                        </div>
										<div class="form-group row">
										...
										<div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="date" class="form-control" id="val-digits" name="checkout" min="<?php echo date($row['checkot']);?>" value="<?php echo $row['checkout']?>" onkeydown="return false">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-lg-8 ml-auto">
                                                <button type="edit_date" class="btn btn-success" name="edit_date">Change Date</button>
                                            </div>
                                        </div>
                                    </form>
						    </div>
                    ...
                    <div class="col-lg-6">
					   ...
					   <form class="form-valide" method="post" enctype="multipart/form-data">
									...
									<div class="form-group row">
										 ...
										 <div class="form-group row">
                                            <div class="col-lg-8 ml-auto">
											     <button class="btn btn-success" name="done"><a href="pendingcheckin.php">Done</a></button>
