...
if(isset($_POST["btn_update"]))
{
  ...
  if($_FILES["image"]["tmp_name"]!=''){
   ...
   $q1="UPDATE `admindash` SET `firstname`='$firstname',`lastname`='$lastname', `username`='$username', `email`='$email',`contact`='$contact',`dob`='$dob',`gender`='$gender',`image`='$image1' where id = '".$_SESSION["id"]."'";
  //$query1=$conn->query($q1);

    if ($conn->query($q1) === TRUE) {
   
      //$_SESSION['success']='Record Successfully Updated';
	 echo "<script type='text/javascript'>alert('Record Successfully Updated');history.go(-1);</script>";
      ?>
...
<?php
$que="select * from  admindash where id = '".$_SESSION["id"]."'";
                ...
                <div class="row">
                                    ...
                                    <form class="form-horizontal" method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text"  value="<?php echo $firstname;?>"  name="firstname" class="form-control" id="event" onkeydown="return alphaOnly(event);" required>
                                                </div>
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text"  value="<?php echo $lastname;?>"  name="lastname" class="form-control" id="event" onkeydown="return alphaOnly(event);" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text"  value="<?php echo $username;?>"  name="username" class="form-control" id="event" onkeydown="return alphaOnly(event);" required>
                                                </div>
                                            </div>
                                        </div>
                                         <div class="form-group">
                  ...
                  <input type="hidden" value="<?=$image?>" name="old_image">
                          <input type="file" class="form-control" name="image">
										...
										<button name="btn_web" class="btn btn-danger btn-flat m-b-30 m-t-30"><a href="index.php">Cancel</a></button>
                                    </form>
                                </div>
                            </div>
                        </div>
