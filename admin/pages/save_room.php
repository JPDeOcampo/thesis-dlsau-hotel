...
extract($_POST);
   ...
   $sql = $conn->query("INSERT INTO `room`(`room_type`, `price`, `bed`, `max`,`photo`,`photo1`,`photo2`,`photo3`,`photo4`) VALUES ('$room_type', '$price', '$bed', '$max', '$photo_name', '$photo_name1', '$photo_name2', '$photo_name3', '$photo_name4')")or die(mysqli_error());
   //$_SESSION['success']=' Record Successfully Added';
   echo "<script type='text/javascript'>alert('Succesfully Add Room!');</script>";
   echo '<script type="text/javascript">window.location="../view_room.php";</script>';
